...
set -g status-left "#[bg=#a0135b,fg=#d5d6db,bold] #S #[bg=#c8c9d1,fg=#a0135b,nobold] "
...
set -g window-status-current-format "#[bg=#a0135b,fg=#d5d6db,bold] #I:#W #[default]"
set -g window-status-separator ""

# panes: border = border color, active = accent
set -g pane-border-style "fg=#72778b"
set -g pane-active-border-style "fg=#a0135b"

# messages and command prompt
set -g message-style "bg=#a0135b,fg=#d5d6db"
...
# clock
set -g clock-mode-colour "#a0135b"
